...
import photoWebp from '../../assets/close-up-excited-person-portrait_23-2151186651.webp';
import photoJpg from '../../assets/close-up-excited-person-portrait_23-2151186651.jpg';
...
export default class AboutPage {
  ...
  renderContact(linkGit: string, linkLinked: string, linkFb: string, linkInsta: string, linkTelegram: string) {
    const contacts = HTMLCreator.createElement('div', { class: 'about-icons' }, [
      HTMLCreator.createElement('a', { class: 'about-link git', htef: linkGit }, [
        HTMLCreator.createElement('img', { src: svgGit, alt: 'git' }),
      ]),
      HTMLCreator.createElement('a', { class: 'about-link linked', htef: linkLinked }, [
        HTMLCreator.createElement('img', { src: svgLinked, alt: 'linked' }),
      ]),
      HTMLCreator.createElement('a', { class: 'about-link fb', htef: linkFb }, [
        HTMLCreator.createElement('img', { src: svgFb, alt: 'developer' }),
      ]),
      HTMLCreator.createElement('a', { class: 'about-link insta', htef: linkInsta }, [
        HTMLCreator.createElement('img', { src: svgInsta, alt: 'developer' }),
      ]),
      HTMLCreator.createElement('a', { class: 'about-link telegram', htef: linkTelegram }, [
  ...
  renderTeamMembersAnastasiaCard() {
    const content = HTMLCreator.createElement('div', { class: 'about-content' }, [
      HTMLCreator.createElement('picture', { class: 'about-image' }, [
        HTMLCreator.createElement('source', { class: 'about-photo', srcset: photoWebp, type: 'image/webp' }, []),
        HTMLCreator.createElement('source', { class: 'about-photo', srcset: photoJpg, type: 'image/jpeg' }, []),
        HTMLCreator.createElement('img', { class: 'about-photo', src: photoJpg, alt: 'developer' }, []),
      ]),
      HTMLCreator.createElement('div', { class: 'about-name' }, ['Anastasia Ramona']),
      HTMLCreator.createElement('div', { class: 'about-position' }, ['Frontend Developer']),
      this.renderAboutList(
        'mailto:aleks6699@gmail.com',
        'aleks6699@gmail.com',
  ...
  renderFooter() {
    const footer = HTMLCreator.createElement('footer', { class: 'about-footer' }, [
        ...
        HTMLCreator.createElement('div', { class: 'footer-wrapper' }, [
          HTMLCreator.createElement('div', { class: 'footer-inner' }, [
            ...
            HTMLCreator.createElement('ul', { class: 'footer-list' }, [
              ...
              HTMLCreator.createElement('li', { class: 'footer-item' }, [
                HTMLCreator.createElement('a', { class: 'footer-link', href: '#' }, ['Anastasia Ramona']),
              ]),
              HTMLCreator.createElement('li', { class: 'footer-item' }, [
                HTMLCreator.createElement('a', { class: 'footer-link', href: '#' }, ['Anastasia Ramona']),
              ]),
      ...
      HTMLCreator.createElement('div', { class: 'about-container' }, [
        HTMLCreator.createElement('section', { class: 'about-team_work' }, [
          ...
          HTMLCreator.createElement('div', { class: 'about-wrapper' }, [
            ...
            this.renderTeamMembersAnastasiaCard(),
