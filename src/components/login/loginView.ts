...
export default class Login {
  ...
  renderPage() {
    ...
    const imageParrot = HTMLCreation.createElement('img', {
      class: 'login__main-container__image',
      src: parrotPath,
      alt: 'parrot',
    });
    const sectionContainer = HTMLCreation.createElement('section', { class: 'login__main-container' }, [
      imageParrot,
      loginWrapper,
    ]);
    const main = HTMLCreation.createElement('main', { class: 'login__main' }, [sectionContainer]);
    return main;
  }
